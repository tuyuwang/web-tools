...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: '投资收益计算器',
    description: '计算复利投资收益，支持定投、一次性投资等多种方式。',
  ...
  },
  {
    ...
    name: '贷款计算器',
    description: '计算房贷、车贷等各类贷款的月供和总利息。',
  ...
  },
  {
    ...
    name: '房贷计算器',
    description: '专业房贷计算，支持等额本息、等额本金两种还款方式。',
  ...
  },
  {
    ...
    name: '复利计算器',
    description: '计算复利增长，理解时间的力量和投资的复合效应。',
  ...
  // 设计工具
  {
    ...
    name: '调色板生成器',
    description: '智能生成和谐的色彩搭配方案，支持多种色彩理论。',
  ...
  },
  {
    ...
    name: '渐变生成器',
    description: '创建美丽的CSS渐变背景，支持线性和径向渐变。',
  ...
  {
    id: 'design-svg-editor',
    name: 'SVG编辑器',
    description: '在线编辑和优化SVG图标，支持基本的图形编辑功能。',
  ...
  },
  {
    ...
    name: 'Favicon生成器',
    description: '快速生成网站图标，支持多种尺寸和格式。',
  ...
  {
    id: 'design-placeholder-generator',
    name: '占位图生成器',
    description: '生成各种尺寸的占位图片，用于设计原型和开发测试。',
  ...
  },
  {
    ...
    name: '文案生成器',
    description: '为Instagram、抖音等平台生成有趣的文案内容。',
  ...
  {
    id: 'social-url-shortener',
    name: '链接缩短器',
    description: '生成短链接，追踪点击数据和分析用户行为。',
    href: '/tools/social/url-shortener',
    icon: 'Link',
    category: 'social',
    popular: false,
  },
  {
    id: 'social-qr-generator',
    name: '二维码生成器',
    description: '生成各种类型的二维码，支持链接、文本、WiFi等。',
  ...
  },
  {
    ...
    name: '内容分析器',
    description: '分析社交媒体内容的情感倾向和关键词密度。',
    href: '/tools/social/content-analyzer',
    icon: 'BarChart3',
    category: 'social',
    popular: false,
  },
  ...
  // 生产力工具
  {
    ...
    name: '番茄时钟',
    description: '专注工作法计时器，提高工作效率和专注力。',
  ...
  },
  {
    ...
    name: '待办事项',
    description: '简洁的任务管理工具，帮助你组织和跟踪日常任务。',
  ...
  },
  {
    ...
    name: '在线笔记',
    description: '云端笔记工具，支持Markdown和实时保存。',
    href: '/tools/productivity/notes',
    icon: 'FileText',
    category: 'productivity',
    popular: false,
  },
  ...
  // 转换工具
  {
    id: 'converter-unit',
    name: '单位转换器',
    description: '全面的单位转换工具，支持长度、重量、温度等各种单位。',
    href: '/tools/converter/unit',
    icon: 'RotateCcw',
    category: 'converter',
    popular: true,
  },
  {
    ...
    name: '时间戳转换',
    description: 'Unix时间戳与人类可读时间的相互转换。',
    href: '/tools/converter/timestamp',
    icon: 'Clock',
    category: 'converter',
    popular: true,
  },
  {
    id: 'converter-pdf',
    name: 'PDF转换器',
    description: '在线PDF转换工具，支持多种文档格式互转。',
    href: '/tools/converter/pdf',
    icon: 'FileType',
    category: 'converter',
    popular: false,
  },
  {
    ...
    name: 'Markdown转换器',
    description: 'Markdown与HTML的相互转换，支持实时预览。',
    href: '/tools/converter/markdown',
    icon: 'FileCode',
    category: 'converter',
    popular: false,
  },
  ...
  // 游戏工具
  {
    id: 'game-2048',
    name: '2048游戏',
    description: '经典的数字拼图游戏，挑战你的逻辑思维。',
    href: '/tools/game/2048',
    icon: 'Gamepad2',
    category: 'game',
    popular: true,
  },
  {
    id: 'game-sudoku',
    name: '数独游戏',
    description: '经典数独游戏，多种难度等级供你挑战。',
    href: '/tools/game/sudoku',
    icon: 'Grid3X3',
    category: 'game',
    popular: false,
  },
  {
    id: 'game-memory',
    name: '记忆游戏',
    description: '翻牌记忆游戏，锻炼你的记忆力和专注力。',
    href: '/tools/game/memory',
    icon: 'Brain',
    category: 'game',
    popular: false,
  },
  {
    ...
    name: '随机选择器',
    description: '从列表中随机选择项目，支持转盘和抽签模式。',
