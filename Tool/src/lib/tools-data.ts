...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'ai-text-summary',
    name: '智能摘要',
    description: '提取文本关键信息，生成简洁摘要，支持多种摘要长度选择。',
  ...
  },
  {
    ...
    name: '情感分析',
    description: '分析文本的情感倾向和语调，提供情感得分、置信度与关键词。',
  ...
  {
    id: 'utility-barcode-generator',
    name: '条形码生成器',
    description: '基于Canvas的真实条形码渲染，支持多种制式并可下载导出。',
    href: '/tools/utility/barcode-generator',
    icon: 'Barcode',
    category: 'utility',
    popular: false,
  },
  {
    id: 'image-exif',
    name: 'EXIF查看/清除',
    description: '读取图片EXIF元数据并可通过重新编码去除隐私信息。',
  ...
  },
  {
    id: 'office-pdf-tools',
    name: 'PDF合并拆分',
    description: '浏览器本地完成PDF合并与页码区间拆分，安全可靠。',
    href: '/tools/office/pdf',
    icon: 'FileText',
    category: 'office',
    popular: true,
  },
